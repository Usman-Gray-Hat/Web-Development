...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center bg-dark text-white py-5 main-heading">FETCHING DATA AFTER CONVERTING INTO JSON - TABLE</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-striped table-hover table-bordered text-center">
                    ...
                    <tbody id="tableContent"> <!-- Table Content Will Be Rendered Here --> </tbody>
                </table>
            </div>
        </div>
    </div>
